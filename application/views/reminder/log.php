                        ...
                        <?php foreach ($logs as $l): ?>
                            <tr class="hover:bg-slate-800/40 transition">
                                ...
                                <td class="px-5 py-3.5">
                                    <div class="font-bold text-white"><?= htmlspecialchars($l['crew_name'] ?: 'Crew') ?></div>
                                    <div class="text-[10px] text-slate-400 font-mono">+<?= htmlspecialchars($l['target_phone']) ?></div>
                                </td>
                                <td class="px-5 py-3.5">
                                    <div class="font-semibold text-slate-200 truncate max-w-xs"><?= htmlspecialchars($l['meeting_title'] ?: '-') ?></div>
                                    <div class="text-[10px] text-sky-400"><?= htmlspecialchars($l['rig_name'] ?: '-') ?></div>
                                </td>

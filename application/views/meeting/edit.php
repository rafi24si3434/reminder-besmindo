            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="topic" rows="2" class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-500 focus:ring-2 focus:ring-sky-500 focus:outline-none transition"><?= htmlspecialchars($meeting['topic']) ?></textarea>
                    </div>
            ...
            <div>
                ...
                <div class="mt-4 p-3.5 bg-slate-800/40 border border-slate-700/60 rounded-xl flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_recurring" value="1" <?= ($meeting['is_recurring'] == 1) ? 'checked' : '' ?> class="w-4 h-4 text-sky-600 bg-slate-800 border-slate-700 rounded focus:ring-sky-500">
                    </label>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 max-h-60 overflow-y-auto p-1 scrollbar-thin">
                    <?php foreach ($crews as $c): ?>
                        <label class="flex items-center space-x-3 p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 hover:bg-slate-800 cursor-pointer transition">
                            ...
                            <div class="truncate">
                                <span class="text-xs font-bold text-white block truncate"><?= htmlspecialchars($c['name']) ?></span>
                                <span class="text-[10px] text-slate-400 truncate block"><?= htmlspecialchars($c['position']) ?></span>
                            </div>
                        </label>
                    <?php endforeach; ?>
                </div>

...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 border-r border-slate-800 transition-transform duration-300 -translate-x-full lg:translate-x-0 flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto px-4 py-4 space-y-6 scrollbar-thin scrollbar-thumb-slate-700">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                <a href="<?= base_url('dashboard') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= $currentSegment === 'dashboard' ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                <a href="<?= base_url('meeting') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= ($currentSegment === 'meeting' && $subSegment !== 'calendar') ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
                    <i class="fa-regular fa-calendar-check w-5 text-center text-base"></i>
                    <span>Jadwal Meeting Rig</span>
                </a>
                <a href="<?= base_url('crew') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= $currentSegment === 'crew' ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
                    <i class="fa-solid fa-users-gear w-5 text-center text-base"></i>
                    <span>Manajemen Crew Rig</span>
                </a>
                <a href="<?= base_url('rig') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= $currentSegment === 'rig' ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <!-- Fase 2 & 3: Undangan & Reminder WhatsApp -->
        <div>
            <span class="px-3 text-[11px] font-bold text-slate-500 tracking-wider uppercase flex items-center justify-between">
            ...
            <div class="mt-2 space-y-1">
                <a href="<?= base_url('reminder') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= ($currentSegment === 'reminder' && $subSegment === '') ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
                ...
                <a href="<?= base_url('reminder/log') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= ($currentSegment === 'reminder' && $subSegment === 'log') ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                <a href="<?= base_url('attendance/live') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= ($currentSegment === 'attendance' && $subSegment === 'live') ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
                ...
                <a href="<?= base_url('attendance/simulator') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= ($currentSegment === 'attendance' && $subSegment === 'simulator') ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                <a href="<?= base_url('report') ?>" 
                    class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-colors <?= $currentSegment === 'report' ? 'bg-sky-600 text-white shadow-md shadow-sky-600/30' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
    ...
    <!-- User Profile & Logout in Bottom Sidebar -->
    <div class="p-4 border-t border-slate-800 bg-slate-950/40">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3 overflow-hidden">
                ...
                <div class="truncate">
                    <p class="text-xs font-semibold text-white truncate"><?= esc(session('name') ?? 'Manager Rig') ?></p>

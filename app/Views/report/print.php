...
<body class="bg-white text-slate-900 p-8 text-xs antialiased max-w-5xl mx-auto">
    ...
    <!-- Print Action Button Bar (Hidden when printed) -->
    ...
    <!-- Official Document Header (Kop Surat Perusahaan) -->
        ...
        <tbody class="divide-y divide-slate-200">
            <?php $no = 1; foreach ($records as $r): ?>
                <tr>
                    ...
                    <td class="p-2 border-r border-slate-200">
                        <strong class="text-slate-900"><?= esc($r['meeting_title']) ?></strong>
                        <span class="block text-slate-500 text-[9px]"><?= esc($r['rig_name']) ?></span>
                    </td>
                    <td class="p-2 border-r border-slate-200">
                        <strong><?= esc($r['crew_name']) ?></strong>
                        <span class="block text-slate-500 text-[9px]"><?= esc($r['nik']) ?></span>
                    </td>
                    <td class="p-2 border-r border-slate-200"><?= esc($r['position']) ?></td>
    ...
    <div class="grid grid-cols-2 gap-8 text-center text-xs mt-12 pt-6">
        ...
        <div>
            ...
            <div class="w-48 mx-auto border-b border-slate-900 pb-1 font-bold"><?= esc(session('name') ?? 'Manager Operasional') ?></div>

<div class="space-y-6">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <p class="text-xs text-slate-400 line-clamp-1"><?= htmlspecialchars($meeting['topic']) ?></p>
        </div>

        <div class="flex items-center space-x-3">
            <a href="<?= htmlspecialchars($meeting['teams_link']) ?>" target="_blank" class="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs flex items-center space-x-2 shadow-lg transition">
